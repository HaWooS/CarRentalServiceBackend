...
public class RentFromDatabase {
    ...
    public RentFromDatabase(){}

    public RentFromDatabase(Long id, int car_id, String username, LocalDateTime start_date, LocalDateTime end_date, boolean rent_paid, double rent_cost, double deposit, double fuel_cost, boolean deposit_paid, int box_code) {
        this.id = id;
        this.car_id = car_id;
