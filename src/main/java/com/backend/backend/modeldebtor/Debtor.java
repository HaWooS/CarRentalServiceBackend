package com.backend.backend.modeldebtor;
...
public class Debtor implements Serializable {
    ...
    public Debtor(int id,int car_id, String username, LocalDateTime start_date, LocalDateTime end_date, boolean rent_paid, double rent_cost, double deposit, double fuel_cost, boolean deposit_paid, int box_code) {
        this.id=id;
        this.car_id = car_id;
    ...
    public Debtor(int car_id, String username, LocalDateTime start_date, LocalDateTime end_date, boolean rent_paid, double rent_cost, double deposit, double fuel_cost, boolean deposit_paid, int box_code) {
        this.car_id = car_id;
        this.username = username;
        this.start_date = start_date;
        this.end_date = end_date;
